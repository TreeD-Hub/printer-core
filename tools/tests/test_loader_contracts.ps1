...
Assert-Contains "klipper/profiles/treed_v2_corexy_v1/steppers.cfg" '(?s)\[tmc2209 stepper_x\][^\[]*diag_pin:\s*\^PG6' "repo stepper_x uses non-inverted TMC2209 DIAG"
...
Assert-Contains "klipper/profiles/treed_v2_corexy_v1/steppers.cfg" '(?s)\[tmc2209 stepper_y\][^\[]*diag_pin:\s*\^PG9' "repo stepper_y uses non-inverted TMC2209 DIAG"
