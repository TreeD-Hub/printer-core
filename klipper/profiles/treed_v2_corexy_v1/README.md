...
Eddy scan area меньше области печати: текущий штатный сервисный mesh сканирует `X7.5..237.5 / Y5..210`, потому что sensing point датчика смещен относительно сопла и физически не покрывает всю заднюю часть стола.
